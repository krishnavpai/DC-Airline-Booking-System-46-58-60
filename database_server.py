...
def init_seats():
    ...
    if file_create:
        ...
        for loc in locations:
            ...
            seats_df.to_csv(os.path.join(os.getcwd(),f'{seats_dir}/seats_{loc}.csv'),index=False)
...
def update_database(json_data,city):
    ...
    os.remove(os.path.join(os.getcwd(),f'{seats_dir}/seats_{city.lower()}.csv'))
    df.to_csv(os.path.join(os.getcwd(),f'{seats_dir}/seats_{city.lower()}.csv'),index=False)
